package modules.employeeservice.pl.piomin.services.employee.controller;
...
public class EmployeeController {
    ...
    @PostMapping("/")
    public Employee add(@RequestBody
    Employee employee) {
    ...
    @GetMapping("/{id}")
    public Employee findById(@PathVariable("id")
    Long id) {
    ...
    public List<Employee> findByOrganization(@PathVariable("organizationId")
    Long organizationId) {
